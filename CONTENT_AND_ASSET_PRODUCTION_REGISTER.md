...
| Annex | Scope | Counts |
|---|---|---|
| [REGISTER_01_FOUNDATIONS.md](register/REGISTER_01_FOUNDATIONS.md) | Style anchors, production profiles, P0 branding/UI/board assets, six region kits, seven kings, six doctrines | 6 regions, 7 kings, 6 doctrines |
...
| [REGISTER_05_ENCOUNTERS_AND_BOSSES.md](register/REGISTER_05_ENCOUNTERS_AND_BOSSES.md) | Combat scenario modules and boss kits | 96 encounters, 15 boss kits |
| [REGISTER_06_AUDIO_UI_STEAM.md](register/REGISTER_06_AUDIO_UI_STEAM.md) | Additional visual series, audio, Steam store assets and workflow | release audio/UI/store set |
