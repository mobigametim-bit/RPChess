...
assert.strictEqual(state.currentFacts['knowledge.iron_marches.mine_abuse'].type, 'knowledge');
...
console.log('B11 narrative: typed facts, priority resolution, regional chains and player-selected political finale passed.');
