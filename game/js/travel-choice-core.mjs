...
const FLAVOR_POOLS = Object.freeze({
  ...
  settlement:Object.freeze(['За холмом видны огни укреплённого поселения.','Вдалеке показались стены и дым жилых очагов.','Дорога ведёт к месту, где путники могут найти передышку.','На горизонте появляются башни небольшого поселения.','Впереди расположен населённый укреплённый пункт.','Следы телег и торговцев ведут к ближайшему поселению.','За поворотом открывается дорога к обитаемым землям.','Разведчики сообщают о поселении неподалёку.','Вдалеке видны ворота, лавки и крыши жилых домов.','Этот путь ведёт туда, где можно пополнить силы перед дорогой.','За частоколом впереди кипит обычная мирная жизнь.','Дорога постепенно становится оживлённее — рядом поселение.']),
  puzzle:Object.freeze(['Путь преграждает древняя шахматная печать.','На дороге обнаружена позиция, требующая точного решения.','Древний механизм откроет путь только после верного хода.','На каменной плите застыла незавершённая шахматная битва.','Старый хранитель дороги требует доказать мастерство точным ходом.','Перед отрядом возникает доска с фигурами и единственным верным планом.','Руническая дверь реагирует только на правильную шахматную комбинацию.','В заброшенной башне сохранилась задача древнего мастера.','Магическая доска блокирует проход, пока позиция не будет решена.','На перекрёстке стоит стол с фигурами, словно ожидающий именно вас.','Каменные фигуры оживают, предлагая решить старую тактическую загадку.','Путь отмечен знаком шахматного ордена: дальше пропускают только решивших задачу.'])
});
