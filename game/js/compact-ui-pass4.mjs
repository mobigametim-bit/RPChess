...
@media (min-width:901px){
  ...
  body.events-active .events-choice-frame{background:linear-gradient(110deg,rgba(7,10,15,.67),rgba(7,10,15,.62))!important;}
  body.events-active .events-story,
  body.events-active .events-choice{font-size:var(--event-reading-size)!important;}
  body.events-active .events-choice__head strong,
  body.events-active .events-choice__reaction,
  body.events-active .events-choice__hero-line{font-size:1em!important;line-height:1.34!important;}
  body.events-active:has(.events-choice-frame[data-choice-count="5"]) .events-panel,
  body.events-active:has(.events-choice-frame[data-choice-count="6"]) .events-panel{--event-reading-size:clamp(16px,1.05vw,18px);}
  body.travel-choice-active .travel-choice-routes{height:auto!important;min-height:0!important;align-items:start!important;}
  body.travel-choice-active .travel-choice-card{height:auto!important;min-height:0!important;max-height:none!important;align-self:start!important;grid-template-rows:auto auto!important;}
  body.travel-choice-active .travel-choice-card__visual{position:relative!important;width:100%!important;height:auto!important;min-height:0!important;aspect-ratio:3 / 2!important;overflow:hidden!important;}
  body.travel-choice-active .travel-choice-card__overlay{position:absolute!important;z-index:5!important;left:0!important;right:0!important;bottom:0!important;display:flex!important;flex-direction:column!important;gap:6px!important;padding:72px 24px 14px!important;background:linear-gradient(180deg,rgba(3,7,12,0) 0%,rgba(3,7,12,.48) 38%,rgba(3,7,12,.94) 100%)!important;pointer-events:none!important;}
  body.travel-choice-active .travel-choice-card__overlay .travel-choice-card__type{font-size:clamp(28px,2vw,35px)!important;line-height:1!important;}
  ...
  body.travel-choice-active .travel-choice-card__overlay .travel-choice-card__meta--cost-only{margin:3px 0 0!important;padding:0!important;border:0!important;min-height:26px!important;}
  body.travel-choice-active .travel-choice-card__body{height:auto!important;min-height:0!important;padding:13px 24px 15px!important;overflow:hidden!important;justify-content:flex-start!important;}
  body.travel-choice-active .travel-choice-card__flavor{margin:0!important;font-size:clamp(15px,1.03vw,18px)!important;line-height:1.42!important;display:-webkit-box!important;-webkit-box-orient:vertical!important;-webkit-line-clamp:2!important;overflow:hidden!important;}
}
