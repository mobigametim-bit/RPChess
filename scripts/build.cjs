...
const GENERATED_RUNTIME_ASSETS=Object.freeze([
  ...
  'splash_poster.jpg','logo_ru.png','logo_en.png'
...
async function main(){
  ...
  for(const relative of [
    'index.html','BUILD_INFO.json','css/arena.css','js/arena-core.mjs','js/arena-app.mjs','assets/arena','assets/ui/royal_run_flag.png','assets/relics/merchants_scale.png','assets/regions/ashen_dominion/boss_arena.jpg',
    'css/reboot-foundation.css','css/language.css','css/ui-redesign-first-three.css','css/player-identity-chronicle.css','css/classic-chess.css','css/chess-ai-polish.css','css/roster.css','css/skirmish.css','css/skirmish-compact.css','css/battle.css','css/caravan.css','css/battle-compact.css','css/endless-run.css','css/endless-run-compact.css','css/travel-choice.css','css/travel-choice-compact.css','css/ui-redesign-final.css','css/combat-side-colors.css','css/player-rating.css','css/resources.css','css/settlement.css','css/settlement-compact.css','css/starvation.css','css/starvation-compact.css','css/events.css','css/events-v5.css','css/puzzles.css','css/puzzles-compact.css','css/ux-consistency.css','css/playtest-fixes.css','css/landscape-ui-redesign.css','css/artifacts.css',
    'js/reboot-foundation.mjs','js/reboot-audio.mjs','js/music-catalog.mjs','js/platform.mjs','js/cloud-save.mjs','js/i18n.mjs','js/brand-logo.mjs','localization','js/player-identity-core.mjs','js/chronicle-core.mjs','js/player-identity-chronicle.mjs','js/endless-run-core.mjs','js/endless-run-app.mjs','js/classic-chess-engine.mjs','js/classic-chess-app.mjs','js/king-pin-ice.mjs','js/chess-ai-adapter.mjs','js/roster-data.mjs','js/run-persistence.mjs','js/combat-checkpoint.mjs','js/run-lifecycle-events.mjs','js/roster-app.mjs','js/artifact-core.mjs','js/artifact-combat-ui.mjs',
    ...
    'js/skirmish-core.mjs','js/skirmish-obstacles.mjs','js/skirmish-app.mjs','js/chess960.mjs','js/caravan-core.mjs','js/caravan-reward-ui.mjs','js/battle-core.mjs','js/battle-app.mjs','js/battle-mercenaries.mjs','js/battle-route.mjs','js/combat-menu.mjs','js/travel-choice-core.mjs','js/travel-choice-app.mjs','js/ux-consistency.mjs','js/post-redesign-playtest-pass1b.mjs','js/ui-redesign-final.mjs','js/cross-scene-visuals.mjs','js/landscape-ui-redesign.mjs',
    ...
    'assets/vfx/pin_ice_full.png','assets/vfx/pin_ice_partial.png','assets/vfx/aura_white.png','assets/vfx/aura_black.png','assets/vfx/aura_red.png','assets/artifacts','assets/boards/obstacles','assets/doctrines/cavalry/emblem.png','assets/doctrines/royal_court/emblem.png','fonts','music','SFX',
  ...
  assertArtifactAssetBudget(dist);
  assertBrandLogoAssetBudget(dist);
  ...
  console.log(`Runtime artifact assets: ${runtime.artifacts.count}; ${formatBytes(runtime.artifacts.beforeBytes)} -> ${formatBytes(runtime.artifacts.afterBytes)}; saved ${formatBytes(runtime.artifacts.savedBytes)} (${runtime.artifacts.savedPercent.toFixed(1)}%); cache ${cacheText(runtime.artifacts)}`);
  console.log(`Runtime Arena icons: ${runtime.arena.count}; ${formatBytes(runtime.arena.beforeBytes)} -> ${formatBytes(runtime.arena.afterBytes)}; cache ${cacheText(runtime.arena)}`);
  console.log(`Runtime run flag: ${runtime.runFlag.count}; ${formatBytes(runtime.runFlag.beforeBytes)} -> ${formatBytes(runtime.runFlag.afterBytes)}; cache ${cacheText(runtime.runFlag)}`);
  console.log(`Runtime brand logos: ${runtime.brandLogos.count}; ${formatBytes(runtime.brandLogos.beforeBytes)} -> ${formatBytes(runtime.brandLogos.afterBytes)}; saved ${formatBytes(runtime.brandLogos.savedBytes)} (${runtime.brandLogos.savedPercent.toFixed(1)}%); cache ${cacheText(runtime.brandLogos)}`);
  ...
  for(const relative of [
    'css/language.css','css/ui-redesign-first-three.css','css/events.css','css/events-v5.css','css/puzzles.css','css/puzzles-compact.css','css/ux-consistency.css','css/playtest-fixes.css','css/ui-redesign-final.css','css/combat-side-colors.css','css/battle-compact.css','css/travel-choice-compact.css','css/player-rating.css','css/endless-run.css','css/endless-run-compact.css','css/skirmish-compact.css','css/settlement-compact.css','css/starvation-compact.css','css/player-identity-chronicle.css','css/landscape-ui-redesign.css','js/cloud-save.mjs','js/combat-checkpoint.mjs','js/player-identity-core.mjs','js/chronicle-core.mjs','js/player-identity-chronicle.mjs','js/endless-run-core.mjs','js/endless-run-app.mjs','js/events-data.mjs','js/events-core.mjs','js/events-app.mjs','js/puzzles/puzzle-core.mjs','js/puzzles/puzzle-catalog.mjs','js/puzzles/puzzle-app.mjs','js/ux-consistency.mjs','js/post-redesign-playtest-pass1b.mjs','js/ui-redesign-final.mjs','js/cross-scene-visuals.mjs','js/landscape-ui-redesign.mjs','js/encounter-difficulty.mjs','js/player-rating.mjs','js/player-rating-runtime.mjs','js/run-lifecycle-events.mjs','js/race-assets.mjs','js/king-pin-ice.mjs','js/event-narrative.mjs','js/content/content-registry.mjs','js/battle-mercenaries.mjs',
    ...Array.from({length:10},(_,i)=>`js/events/event-data-${String(i+1).padStart(2,'0')}.mjs`),
    'assets/ui/royal_run_flag.png',
    'assets/regions/ashen_dominion/boss_arena.jpg','assets/races/humans/board/white.png','assets/races/humans/board/black.png','assets/vfx/pin_ice_full.png','assets/vfx/pin_ice_partial.png','assets/vfx/aura_white.png','assets/vfx/aura_black.png','assets/vfx/aura_red.png','assets/races/humans/pieces/white/king.png','assets/races/humans/pieces/black/king.png','assets/races/orcs/pieces/pawn.png','assets/events/register-04/backgrounds/generic/forest_crossroad.png','assets/events/register-04/sky_khanate/storm_over_caravan.png','assets/doctrines/cavalry/emblem.png','assets/doctrines/royal_court/emblem.png','generated_assets/node_training.png','generated_assets/node_story.png','generated_assets/scene_campaign.jpg','generated_assets/scene_victory.jpg','generated_assets/scene_reward.jpg','generated_assets/scene_defeat.jpg','generated_assets/logo_ru.png','generated_assets/logo_en.png','SFX/win_fanfare.mp3',
