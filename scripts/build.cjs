...
async function main(){
  ...
  for(const relative of [
    ...
    'css/reboot-foundation.css','css/classic-chess.css','css/chess-ai-polish.css','css/roster.css','css/skirmish.css','css/battle.css','css/travel-choice.css','css/player-rating.css','css/resources.css','css/settlement.css','css/starvation.css','css/events.css','css/puzzles.css','css/ux-consistency.css','css/endless-run.css',
    ...
    'js/encounter-difficulty.mjs','js/player-rating.mjs','js/player-rating-runtime.mjs','js/race-assets.mjs','js/event-narrative.mjs','js/content','js/endless-run-core.mjs','js/endless-run-app.mjs',
  ...
  for(const relative of [
    'css/events.css','css/puzzles.css','css/ux-consistency.css','css/player-rating.css','css/endless-run.css','js/events-data.mjs','js/events-core.mjs','js/events-app.mjs','js/puzzles/puzzle-core.mjs','js/puzzles/puzzle-catalog.mjs','js/puzzles/puzzle-app.mjs','js/ux-consistency.mjs','js/cross-scene-visuals.mjs','js/encounter-difficulty.mjs','js/player-rating.mjs','js/player-rating-runtime.mjs','js/race-assets.mjs','js/event-narrative.mjs','js/content/content-registry.mjs','js/endless-run-core.mjs','js/endless-run-app.mjs',
  ...
  ])if(!fs.existsSync(path.join(dist,relative)))throw new Error(`Reboot build output missing: ${relative}`);
  console.log(`Prepared RPChess Reboot distribution in ${dist}; Stockfish ${stockfish.version}`);
}
