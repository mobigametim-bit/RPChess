...
async function main(){
  ...
  for(const relative of [
    'index.html','BUILD_INFO.json','css/arena.css','js/arena-core.mjs','js/arena-app.mjs','assets/arena','assets/relics/merchants_scale.png','assets/regions/ashen_dominion/boss_arena.jpg',
