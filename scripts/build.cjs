...
async function main(){
  ...
  for(const relative of [
    ...
    'assets/vfx/pin_ice_full.png','assets/vfx/pin_ice_partial.png','assets/vfx/aura_white.png','assets/vfx/aura_black.png','assets/vfx/aura_red.png','assets/artifacts','assets/boards/obstacles','assets/doctrines/cavalry/emblem.png','fonts','music','SFX',
